...
const temperamentCores: Record<string, TemperamentCore> = {
  S: {
    ...
    humor: '혈액(Blood)',
    season: '봄',
    coreWeakness: '의지가 약하고 무질서한 경향이 있습니다. 감정이 예민하고 활동적이지만, 하나의 일에 끈기 있게 집중하기 어렵습니다. 히포크라테스는 혈액이 과다한 사람이 쾌활하지만 변덕스럽다고 보았습니다.',
    ...
    hiddenSelf: '밝은 웃음 뒤에 "나를 진짜로 이해해주는 사람이 있을까"라는 외로움을 간직하고 있습니다. 넓지만 얕은 관계들 속에서, 정작 자신의 깊은 내면을 보여줄 수 있는 사람은 극소수입니다.',
  ...
  C: {
    ...
    season: '여름',
    coreWeakness: '의지와 투쟁심이 강하지만 오만해질 수 있습니다. 독립적이고 결단력이 있으나, 타인의 의견을 무시하고 자기 방식만을 고집하는 독선에 빠지기 쉽습니다. 히포크라테스는 담즙이 과다한 사람이 화를 잘 내고 공격적이라고 보았습니다.',
    ...
    hiddenSelf: '강한 모습 뒤에 "내가 충분히 잘하고 있는 걸까"라는 끊임없는 자기 검증을 하고 있습니다. 관계가 적고, 깊은 유대를 형성하기 어려우며, 분노 폭발 후에 깊은 후회를 느끼지만 이를 잘 드러내지 않습니다.',
  ...
  P: {
    ...
    humor: '점액(Phlegm)',
    season: '겨울',
    coreWeakness: '유머와 명랑함이 있지만 느긋한 특성으로 인한 게으름이 약점입니다. 변화를 싫어하고 현상 유지에 안주하며, 결단이 필요한 순간에 우유부단해질 수 있습니다. 히포크라테스는 점액이 과다한 사람이 무기력하고 소극적이라고 보았습니다.',
    ...
    hiddenSelf: '온화한 태도 뒤에 "내 목소리도 들어줄 사람이 있으면 좋겠다"라는 간절함을 품고 있습니다. 갈등 회피가 심해 문제를 키울 수 있고, 표면 아래에 원망과 좌절을 축적합니다.',
  ...
  M: {
    ...
    season: '가을',
    coreWeakness: '풍부한 감성을 지니지만 자기중심적이며 변덕스러울 수 있습니다. 자기 감정에 깊이 몰입하여 타인의 관점을 놓치고, 이상과 현실의 괴리에서 오는 좌절감에 빠지기 쉽습니다. 히포크라테스는 흑담즙이 과다한 사람이 비관적이고 근심이 많다고 보았습니다.',
    ...
    hiddenSelf: '차분한 겉모습 아래 "이 세상은 왜 내가 생각하는 것처럼 아름답지 않을까"라는 깊은 아쉬움이 있습니다. 자신의 기준에 미치지 못하면 자기 비판이 시작되고, 세상의 잔혹함과 비극에 몰두하여 우울에 빠지기 쉽습니다.',
