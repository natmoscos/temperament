...
function hero() {
  ...
  <rect x="180" y="280" width="840" height="320" rx="32" fill="#ffffff" stroke="${C.goldDeep}" stroke-width="3" opacity="0.97"/>
  <text x="600" y="360" text-anchor="middle" font-size="22" font-weight="700" fill="${C.goldDeep}">192TYPES · WEALTH PATH 2026</text>
  <text x="600" y="440" text-anchor="middle" font-size="48" font-weight="900" fill="${C.text}">MBTI 16유형 부 축적 경로</text>
  <text x="600" y="495" text-anchor="middle" font-size="26" font-weight="700" fill="${C.textSoft}">20대 → 60대 자산 설계 로드맵</text>
  <text x="600" y="555" text-anchor="middle" font-size="16" font-weight="600" fill="${C.textMuted}">유형별 최적 자산 · 소득 루트 · 시기별 전략</text>
  `);
}
