...
function hero() {
  ...
  <rect x="80" y="250" width="1040" height="410" rx="36" fill="#ffffff" stroke="${C.fitDeep}" stroke-width="4" opacity="0.97"/>
  <text x="600" y="330" text-anchor="middle" font-size="30" font-weight="800" fill="${C.fitDeep}">192TYPES · DIET REPORT 2026</text>
  <text x="600" y="430" text-anchor="middle" font-size="72" font-weight="900" fill="${C.text}">MBTI 다이어트 성공 공식</text>
  <text x="600" y="505" text-anchor="middle" font-size="40" font-weight="700" fill="${C.textSoft}">감량 성공률 + 요요 위험 랭킹</text>
  <text x="600" y="605" text-anchor="middle" font-size="24" font-weight="600" fill="${C.textMuted}">네 유형에 맞는 식단 · 운동 · 동기부여 전략</text>
  `);
}
